# NR - Zeitreihen (1991-): Parteien (csv)
...
| Zeitraum | 1991–2023 |
| Geografie | Canton |
| Resource ID | `ckan:eidg-wahlen-2023:89ddc561-9544-4021-8b7d-13271c5f939d` |

## Quelle

[Datensatzseite](https://opendata.swiss/de/dataset/eidg-wahlen-2023) · [Direkte Datenquelle](https://ogd-static.voteinfo-app.ch/v4/ogd/sd-t-17.02-NRW2023-zeitreihen-parteien-appendix.csv)
...
[Source-specific open-data terms](https://opendata.swiss/de/dataset/eidg-wahlen-2023). bundesamt-fur-statistik-bfs

## Verwendung im MCP

1. Mit `get_resource_profile` die Resource ID `ckan:eidg-wahlen-2023:89ddc561-9544-4021-8b7d-13271c5f939d` laden.
